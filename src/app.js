...
const pattyItem= document.getElementById("item-patty")
const cheeseItem= document.getElementById("item-cheese")
const tomatoesItem= document.getElementById("item-tomato")
const onionsItem= document.getElementById("item-onion")
const lettuceItem= document.getElementById("item-lettuce")

const patty = document.getElementById("patty");
const cheese = document.getElementById("cheese");  
const tomatoes = document.getElementById("tomato"); 
const onions = document.getElementById("onion"); 
